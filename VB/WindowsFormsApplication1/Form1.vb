        ...
        Public Class PictureObject
            ...
            Public Sub New(ByVal name As String, ByVal url As String)
                ...
                AddHandler bg.Loaded, Sub(s, e)
                    Image = bg.Result
                    If Not(TypeOf Image Is Image) Then Image = ResourceImageHelper.CreateImageFromResources("DevExpress.XtraEditors.Images.Error.png", GetType(BackgroundImageLoader).Assembly)
